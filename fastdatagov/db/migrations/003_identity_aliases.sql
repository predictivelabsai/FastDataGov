...
CREATE TABLE fast_datagov.principal_aliases (
...
CREATE INDEX principal_alias_identity_idx ON fast_datagov.principal_aliases(identity_principal_type, identity_key);
